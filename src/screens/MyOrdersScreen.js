    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.tabContainer}>
          ...
          >
            <Text style={[styles.tabButtonText, selectedCategory === 'Completed' && styles.selectedTabButtonText]}>
              Completed
            </Text>
            {selectedCategory === 'Completed' && <View style={styles.tabIndicator} />}
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.tabButton}
            onPress={() => setSelectedCategory('Cancelled')}
          >
            <Text style={[styles.tabButtonText, selectedCategory === 'Cancelled' && styles.selectedTabButtonText]}>
              Cancelled
            </Text>
            {selectedCategory === 'Cancelled' && <View style={styles.tabIndicator} />}
          </TouchableOpacity>
        </View>
        {orders
          .filter((order) => {
            if (selectedCategory === 'Ongoing') return order.status === 'Current';
